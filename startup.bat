...
start "" "C:\Users\pulip\Downloads\x86_64-pc-windows-msvc-simple-http-server.exe"
start "" "C:\Program Files\Google\Chrome\Application\chrome.exe" --kiosk "http://localhost:8000/Fullscreen-Quad-Webcam-Viewer-main/index.html#/"
