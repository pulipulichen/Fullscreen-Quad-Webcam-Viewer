...
const server = http.createServer((req, res) => {
  if (req.method === 'GET') {
    console.log('Received GET request. Executing sudo poweroff...');
...
server.listen(port, () => {
  ...
  console.log(`Access http://localhost:${port} to trigger 'sudo poweroff'`);
  console.warn('WARNING: Executing "sudo poweroff" requires sudo privileges and may prompt for a password.');
